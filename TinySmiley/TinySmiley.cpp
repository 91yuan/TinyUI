...
namespace Tiny
{
	...
	{
		if (IsEqualIID(riid, IID_ISmiley) || IsEqualIID(riid, IID_ISmiley))
		{
			*ppvObject = this;
		}
		else
	...
	{
		if (IsEqualIID(riid, IID_IClassFactory) || IsEqualIID(riid, IID_IClassFactory))
		{
			*ppvObject = this;
		}
		else
